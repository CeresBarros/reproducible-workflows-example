...
```{r fig-baselineproj, eval = TRUE, echo = FALSE, fig.height = 4, fig.width = 4, fig.cap = "Random forest projections of white spruce distributions in BC, Canada, under baseline conditions of four bioclimatic variables (annual mean temperature and annual precipitation, temperature and precipitation seasonality."}
knitr::include_graphics("figures/SDMprojections_baseline.png")
```

```{r fig-futureproj, eval = TRUE, echo = FALSE, fig.height = 4, fig.width = 4, fig.cap="Random forest projections of white spruce distributions in BC, Canada, for future values of the same four bioclimatic variables -- only one GCM and one emissions scenario were used."}
knitr::include_graphics(rep("figures/SDMprojections_future.png"))
```
