...
if (packageVersion("Require") < "0.3.0") {
  packageURL <- "https://cran.r-project.org/src/contrib/Archive/Require/Require_0.3.0.tar.gz"
...
# Require(packageVersionFile = pkgSnapshotFile, libPaths = projPaths$pkgPath)
